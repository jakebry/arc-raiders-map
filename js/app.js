...
function renderMarkers() {
    ...
    keys.forEach(key => {
        ...
        const icon = L.divIcon({
            ...
            ` : `
                <div class="marker-icon-container" style="border-color: ${rarity.color}; box-shadow: 0 0 12px ${rarity.color}, 0 2px 8px rgba(0, 0, 0, 0.6); background: radial-gradient(circle at 15% 85%, ${rarity.color}40 0%, transparent 60%), rgba(25, 25, 35, 0.95);">
