...
export const MAPS = [
    ...
    { id: 'spaceport', name: 'Spaceport', image: `${BLOB}/images/maps/spaceport.jpg`, preview: `${BLOB}/images/preview/spaceport.jpg`, width: 4896, height: 4896, border: 400, overheadCoords: { top: '25%', left: '22%' } },
    { id: 'buried_city', name: 'Buried City', image: `${BLOB}/images/maps/buried_city.jpg`, preview: `${BLOB}/images/preview/buried_city.jpg`, width: 4896, height: 4896, border: 400, overheadCoords: { top: '55%', left: '12%' } },
    { id: 'blue_gate', name: 'Blue Gate', image: `${BLOB}/images/maps/blue_gate.jpg`, preview: `${BLOB}/images/preview/blue_gate_zoomed.jpg`, width: 4896, height: 3872, border: 400, overheadCoords: { top: '45%', left: '72%' } },
    {
        id: 'stella_montis', name: 'Stella Montis', image: `${BLOB}/images/maps/stella_montis_upper_original.png`, preview: `${BLOB}/images/preview/stella_montis.jpg`, width: 4096, height: 3072, border: 0, overheadCoords: { top: '15%', left: '80%' },
        levels: {
            upper: { image: `${BLOB}/images/maps/stella_montis_lower_original.png`, width: 5120, height: 3072 },
            lower: { image: `${BLOB}/images/maps/stella_montis_upper_original.png`, width: 4096, height: 3072 }
        }
    }
];
...
export const KEYS = [
    {
        id: 'dam_surveillance', map: 'dam', name: 'Dam Surveillance Key', rarity: 'uncommon', coords: [2137, 2127], location: 'Water Treatment Control — Southwestern Hallway', doorImage: `${BLOB}/images/doors/dam_battlegrounds/surveillance_door.webp`, icon: `${BLOB}/images/keys/dam_battlegrounds_key.png`,
    ...
    {
        id: 'dam_staff_room', map: 'dam', name: 'Dam Staff Room Key', rarity: 'uncommon', coords: [2039, 2780], location: 'Research & Administration — First Floor', doorImage: `${BLOB}/images/doors/dam_battlegrounds/staff_room_door.webp`, icon: `${BLOB}/images/keys/dam_battlegrounds_key.png`,
    ...
    {
        id: 'dam_testing_annex', map: 'dam', name: 'Dam Testing Annex Key', rarity: 'rare', coords: [1573, 3269], location: 'Testing Annex — Ground Floor (Two Doors)', doorImage: `${BLOB}/images/doors/dam_battlegrounds/testing_annex_door.jpg`, icon: `${BLOB}/images/keys/dam_battlegrounds_key.png`,
    ...
    {
        id: 'dam_control_tower', map: 'dam', name: 'Dam Control Tower Key', rarity: 'epic', coords: [2108, 2801], location: 'Control Tower — Top Floor', doorImage: `${BLOB}/images/doors/dam_battlegrounds/control_tower_door.webp`, icon: `${BLOB}/images/keys/dam_battlegrounds_key.png`,
    ...
    {
        id: 'sp_trench_tower', map: 'spaceport', name: 'Spaceport Trench Tower Key', rarity: 'uncommon', coords: [3628, 2679], location: 'North or South Trench Tower (Between West/East Hangers)', doorImage: `${BLOB}/images/doors/spaceport/trench_tower_door.webp`, icon: `${BLOB}/images/keys/spaceport_key.png`,
    ...
    {
        id: 'sp_warehouse', map: 'spaceport', name: 'Spaceport Warehouse Key', rarity: 'uncommon', coords: [3707, 2243], location: 'Shipping Warehouse — Top of Catwalk', doorImage: `${BLOB}/images/doors/spaceport/warehouse_door.jpg`, icon: `${BLOB}/images/keys/spaceport_key.png`,
    ...
    {
        id: 'sp_ground_control', map: 'spaceport', name: 'Spaceport Control Tower Key', rarity: 'uncommon', coords: [2473, 2568], location: 'Ground Control Tower — Upper Level', doorImage: `${BLOB}/images/doors/spaceport/control_tower_door.webp`, icon: `${BLOB}/images/keys/spaceport_key.png`,
    ...
    {
        id: 'sp_container_storage', map: 'spaceport', name: 'Spaceport Container Storage Key', rarity: 'rare', coords: [2366, 3004], location: 'Container Storage — Top Floor Red Door', doorImage: `${BLOB}/images/doors/spaceport/container_storage_doors.jpg`, icon: `${BLOB}/images/keys/spaceport_key.png`,
    ...
    {
        id: 'bc_residential', map: 'buried_city', name: 'Buried City Residential Master Key', rarity: 'uncommon', coords: [1916, 1779], location: 'Plaza Rosa Area / Grandioso Apartments', doorImage: `${BLOB}/images/doors/buried_city/residential_grandioso.jpg`, icon: `${BLOB}/images/keys/buried_city_key.png`,
    ...
    {
        id: 'bc_jkv', map: 'buried_city', name: 'Buried City JKV Employee Card', rarity: 'uncommon', coords: [2696, 2768], location: 'Space Travel Building — Northeast Section', doorImage: `${BLOB}/images/doors/buried_city/jkv_access_door.webp`, icon: `${BLOB}/images/keys/buried_city_key.png`,
    ...
    {
        id: 'bc_hospital', map: 'buried_city', name: 'Buried City Hospital Key', rarity: 'rare', coords: [3247, 2419], location: 'Hospital — Third Floor Northwest', doorImage: `${BLOB}/images/doors/buried_city/hospital_door.webp`, icon: `${BLOB}/images/keys/buried_city_key.png`,
    ...
    {
        id: 'bc_town_hall', map: 'buried_city', name: 'Buried City Town Hall Key', rarity: 'epic', coords: [2282, 2592], location: 'Town Hall — Northern Side Ground Level', doorImage: `${BLOB}/images/doors/buried_city/town_hall_entrance.webp`, icon: `${BLOB}/images/keys/buried_city_key.png`,
    ...
    {
        id: 'bg_village', map: 'blue_gate', name: 'Blue Gate Village Key', rarity: 'uncommon', coords: [2877, 1718], location: 'Village — House with Barred Front Door', doorImage: `${BLOB}/images/doors/blue_gate/village_door.jpg`, icon: `${BLOB}/images/keys/blue_gate_key_variant_1.png`,
    ...
    {
        id: 'bg_patrol_car', map: 'blue_gate', name: 'Blue Gate Patrol Car Key', rarity: 'uncommon', coords: [2234, 2621], location: 'Traffic Tunnel — Armored Patrol Car Rear Door', icon: `${BLOB}/images/keys/patrol_car_key.png`,
    ...
    {
        id: 'bg_comm_tower', map: 'blue_gate', name: 'Blue Gate Communication Tower Key', rarity: 'rare', coords: [2838, 3595], location: 'Communication Tower — Underground Storage Room', doorImage: `${BLOB}/images/doors/blue_gate/comm_tower_door.webp`, icon: `${BLOB}/images/keys/blue_gate_key_variant_2.png`,
    ...
    {
        id: 'bg_cellar', map: 'blue_gate', name: 'Blue Gate Cellar Key', rarity: 'rare', coords: [1153, 2081], location: 'Cellar South of Ruined Homestead', doorImage: `${BLOB}/images/doors/blue_gate/cellar_door_1.webp`, icon: `${BLOB}/images/keys/blue_gate_key_variant_1.png`,
    ...
    {
        id: 'bg_confiscation', map: 'blue_gate', name: 'Blue Gate Confiscation Room Key', rarity: 'epic', coords: [2540, 2485], location: 'Headhouse — Underground Tunnel System', doorImage: `${BLOB}/images/doors/blue_gate/confiscation_door.jpg`, icon: `${BLOB}/images/keys/blue_gate_key_variant_2.png`,
    ...
    {
        id: 'sm_assembly', map: 'stella_montis', name: 'Stella Montis Assembly Admin Key', rarity: 'uncommon', coords: [2406, 990], location: 'Assembly — Central Corridor (Western Section)', level: 'upper', doorImage: `${BLOB}/images/doors/stella_montis/assembly_admin_door.webp`, icon: `${BLOB}/images/keys/stella_montis_key.png`,
    ...
    {
        id: 'sm_medical', map: 'stella_montis', name: 'Stella Montis Medical Storage Key', rarity: 'uncommon', coords: [1842, -366], location: 'Medical Research — North Side', level: 'upper', doorImage: `${BLOB}/images/doors/stella_montis/medical_storage_door.webp`, icon: `${BLOB}/images/keys/stella_montis_key.png`,
    ...
    {
        id: 'sm_archives', map: 'stella_montis', name: 'Stella Montis Archives Key', rarity: 'rare', coords: [2032, 3684], location: 'Seed Vault — End of Tunnels', level: 'lower', doorImage: `${BLOB}/images/doors/stella_montis/archives_storage_door.jpg`, icon: `${BLOB}/images/keys/stella_montis_key.png`,
    ...
    {
        id: 'sm_security', map: 'stella_montis', name: 'Stella Montis Security Checkpoint Key', rarity: 'epic', coords: [2422, 2499], location: 'Lobby — Northern Section', level: 'upper', doorImage: `${BLOB}/images/doors/stella_montis/security_locked_room.jpg`, icon: `${BLOB}/images/keys/stella_montis_key.png`,
    ...
    {
        id: 'hatch_dam_1', map: 'dam', name: 'Raider Hatch Key', rarity: 'rare', coords: [1762, 1731], location: 'Sunroof Hatch — Trees Above Ben Welder\'s Sunroof', icon: `${BLOB}/images/keys/raider_hatch_key.png`,
    ...
    {
        id: 'hatch_dam_2', map: 'dam', name: 'Raider Hatch Key', rarity: 'rare', coords: [2662, 3751], location: 'Spillway Hatch — South of Red Lakes Berm', icon: `${BLOB}/images/keys/raider_hatch_key.png`,
        description: 'Unlocks a raider hatch for quick extraction.',
        instructions: 'Provides access to emergency extraction hatches. Use for quick exits when under pressure.',
        weight: 0.25, value: 100
    },
    {
        id: 'hatch_sp_1', map: 'spaceport', name: 'Raider Hatch Key', rarity: 'rare', coords: [3218, 3266], location: 'West Elevator Hatch — West of Departure Building', icon: `${BLOB}/images/keys/raider_hatch_key.png`,
        description: 'Unlocks a raider hatch for quick extraction.',
        instructions: 'Provides access to emergency extraction hatches. Use for quick exits when under pressure.',
        weight: 0.25, value: 100
    },
    {
        id: 'hatch_sp_2', map: 'spaceport', name: 'Raider Hatch Key', rarity: 'rare', coords: [2440, 2282], location: 'Central Elevator Hatch — East of Arrival Building', icon: `${BLOB}/images/keys/raider_hatch_key.png`,
        description: 'Unlocks a raider hatch for quick extraction.',
        instructions: 'Provides access to emergency extraction hatches. Use for quick exits when under pressure.',
        weight: 0.25, value: 100
    },
    {
        id: 'hatch_bc_1', map: 'buried_city', name: 'Raider Hatch Key', rarity: 'rare', coords: [2830, 1802], location: 'Cargo Elevator Hatch', icon: `${BLOB}/images/keys/raider_hatch_key.png`,
        description: 'Unlocks a raider hatch for quick extraction.',
        instructions: 'Provides access to emergency extraction hatches. Use for quick exits when under pressure.',
        weight: 0.25, value: 100
    },
    {
        id: 'hatch_bc_2', map: 'buried_city', name: 'Raider Hatch Key', rarity: 'rare', coords: [3374, 2588], location: 'Metro Station Hatch', icon: `${BLOB}/images/keys/raider_hatch_key.png`,
        description: 'Unlocks a raider hatch for quick extraction.',
        instructions: 'Provides access to emergency extraction hatches. Use for quick exits when under pressure.',
        weight: 0.25, value: 100
    },
    {
        id: 'hatch_bg_1', map: 'blue_gate', name: 'Raider Hatch Key', rarity: 'rare', coords: [2711, 2851], location: 'Airshaft Extraction Point', icon: `${BLOB}/images/keys/raider_hatch_key.png`,
        description: 'Unlocks a raider hatch for quick extraction.',
        instructions: 'Provides access to emergency extraction hatches. Use for quick exits when under pressure.',
        weight: 0.25, value: 100
    },
    {
        id: 'hatch_bg_2', map: 'blue_gate', name: 'Raider Hatch Key', rarity: 'rare', coords: [3039, 4164], location: 'Airshaft Extraction Point', icon: `${BLOB}/images/keys/raider_hatch_key.png`,
        description: 'Unlocks a raider hatch for quick extraction.',
        instructions: 'Provides access to emergency extraction hatches. Use for quick exits when under pressure.',
        weight: 0.25, value: 100
    },
    {
        id: 'hatch_sm_1', map: 'stella_montis', name: 'Raider Hatch Key', rarity: 'rare', coords: [2872, 952], location: 'Assembly Workshops Hatch — Bottom Right of Assembly', level: 'upper', icon: `${BLOB}/images/keys/raider_hatch_key.png`,
        description: 'Unlocks a raider hatch for quick extraction.',
        instructions: 'Provides access to emergency extraction hatches. Use for quick exits when under pressure.',
        weight: 0.25, value: 100
    },
    {
        id: 'hatch_sm_2', map: 'stella_montis', name: 'Raider Hatch Key', rarity: 'rare', coords: [1020, 2896], location: 'Sandbox B Hatch — Very South of Map', level: 'lower', icon: `${BLOB}/images/keys/raider_hatch_key.png`,
        description: 'Unlocks a raider hatch for quick extraction.',
        instructions: 'Provides access to emergency extraction hatches. Use for quick exits when under pressure.',
        weight: 0.25, value: 100
    },
